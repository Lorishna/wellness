...
image = Image.open("breathing.jpg")
resized_image = image.resize((1000, 200))  # Width: 200px, Height: 150px
...
st.write("10 minute follow along breathing audio :- ")
st.write("    ")
st.audio("breathingaudio.M4A")
st.write("https://www.mindful.org/audio-resources-for-mindfulness-meditation/")
